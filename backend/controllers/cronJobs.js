...
import { cleanupStaleDemoUsers } from '../controllers/userController.js';
...
export const cronJobGame1p = (io) => {
  ...
  // DEMO CLEANUP - Every hour: remove demo accounts older than 24h (forgotten logouts)
  cron.schedule('0 * * * *', async () => {
    runsWithLock('demoCleanup', cleanupStaleDemoUsers, 'cleanupStaleDemoUsers');
  });
};
