...
export const getVideoStreamUrl = (gameid) => {
  ...
  // return `https://81habibi.com/api/v1/casino-tv?gmid=${gameid}&key=gk_3c1d07f137ec71f3463fb74d4dcf3a764e1fb1d5591a2c50`;
  return `https://81habibi.com/api/v1/casino-tv?gmid=${gameid}&key=gk_04ea49896e4ac08609eb6ff4c8964b1ef786a66e6a849846`;
};
