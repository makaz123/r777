...
import playtect from '../../assets/provider/provider-playtech-live.png';
import sexy from '../../assets/provider/provider-sexybcrt.png';
import kmIcon from '../../assets/provider/provider-kingmaker.png';
import jiliIcon from '../../assets/provider/provider-jili-gaming.png';
...
const TABS = [
  ...
  { id: 'playtech', label: 'Playtech Live', icon: playtect },
  { id: 'sexybcrt', label: 'SEXYBCRT', icon: sexy },
  { id: 'km', label: 'KINGMAKER', icon: kmIcon },
  { id: 'jili', label: 'JiLi Gaming', icon: jiliIcon },
];

const playtechGames = casinoData.providers.playtech ?? [];
const kmGames = casinoData.providers.km ?? [];
const jiliGames = casinoData.providers.jili ?? [];

const playtechLiveGames = playtechGames.filter((game) =>
  /live/i.test(game.game_name)
);
...
function getGamesForTab(tabId) {
  switch (tabId) {
    ...
    case 'all':
    default:
      return [...playtechGames, ...kmGames, ...jiliGames];
  }
}
